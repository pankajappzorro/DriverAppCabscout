            ...
            if (s != null) {
                try {
                    ...
                    if (id >= 1) {
                        ...
                        new ExecuteApiUserDetails(context).execute(Operations.getUserDetail(context, String.valueOf(id)));
            ...
            if (s != null) {
                try {
                    ...
                    if (id >= 1) {
                        ...
                        new ExecuteApiUserDetails(mContext).execute(Operations.getUserDetail(mContext, String.valueOf(id)));
